<template>
    <div class="container">
        ...
        <ul>
            ...
            <li>Mit dem Kauf eines Tickets akzeptierst du die <a href="assets/AGB PFF Stäfa 2019 Besucher.pdf"
                                                                 target="_blank">Allgemeinen Geschäftsbedingungen</a> (AGB) des Vereins PFF Stäfa 2019.</li>
