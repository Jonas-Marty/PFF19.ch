        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <ul class="list-group list-group-flush">
              ...
              >Zutritt zum Festivalgelände und zum Zeltplatz von Freitag bis Sonntag</li>
              <li class="list-group-item">Goodie-Bag inkl. 1x Festivalbecher</li>
              <li
                class="list-group-item"
              >Verpflegung: 2x Abend, 2x Morgen. Bitte bring Dein Essgeschirr mit.</li>
              <li class="list-group-item">Shuttlebus vom Bahnhof Stäfa zum Festivalgelände</li>
              <li
                class="list-group-item"
              >Vergünstigte Anreise mit SBB beim Kauf eines Tickets bis 31. Mai 2019</li>
            </ul>
          </div>
        </div>
      </div>
