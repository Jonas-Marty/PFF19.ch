    ...
    <div class="container">
        <div class="impressum">
            ...
            <p>
                ...
                Dateien auf der Website gehören ausschliesslich
                <strong>des Vereins PFF Stäfa 2019</strong> oder den speziell genannten
            ...
            <p>
                ...
                persönlichen Daten. Wir halten diese Bestimmungen ein. Persönliche Daten werden
            ...
            <p>
                ...
                Datenbanken so gut wie möglich vor fremden Zugriffen, Verlusten, Missbrauch oder vor
                Fälschung zu schützen.
            </p>
            <p>
                Beim Zugriff auf unsere Webseiten werden folgende Daten in Logfiles gespeichert:
                IP-Adresse, Datum, Uhrzeit, Browser-Anfrage und allg. übertragene Informationen zum
                Betriebssystem resp. Browser. Diese Nutzungsdaten bilden die Basis für statistische,
            ...
            <h2>Quelle</h2>
            <p>
                Dieses Impressum wurde am
                <strong>09.08.2018</strong> mit dem Impressum-Generator
                <strong>
                    <a href="http://www.bag.ch/impressum-generator"
                        >http://www.bag.ch/impressum-generator</a
                    >
                </strong>
                der Firma Brunner Medien AG in Kriens erstellt. Die Brunner Medien AG in Kriens
...
export default {
    metaInfo() {
        return {
            title: `| ${this.$i18n.t('lang.navigation.impressum')}`
        }
    }
}
</script>
