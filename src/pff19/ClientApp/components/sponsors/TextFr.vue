<template>
    <div>
        <h1>Sponsors</h1>
            ...
            <p>
                Quand vous voudriez que le paiement soit anonyme, mentionnez vous le au 
                motif du paiement. Autrement nous vous listons comme bienfaiteur/-trice avec plaisir.
            </p>
