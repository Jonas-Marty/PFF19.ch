<template>
    <div class="container">
        ...
        <div class="sponsors" v-if="coSponsors && coSponsors.length > 0">
            ...
            <div class="row">
                <app-sponsor v-for="sponsor in coSponsors" :key="sponsor.id" :sponsor="sponsor">
                </app-sponsor>
            </div>
        </div>
        ...
        <div class="sponsors" v-if="partner && partner.length > 0">
            ...
            <div class="row">
                <app-sponsor v-for="sponsor in partner" :key="sponsor.id" :sponsor="sponsor">
                </app-sponsor>
            </div>
        </div>
        ...
        <div class="sponsors" v-if="infrapartner && infrapartner.length > 0">
            ...
            <div class="row">
                <app-sponsor v-for="sponsor in infrapartner" :key="sponsor.id" :sponsor="sponsor">
                </app-sponsor>
            </div>
        </div>
        ...
        <div class="sponsors" v-if="scoutpartner && scoutpartner.length > 0">
            ...
            <div class="row">
                <app-sponsor v-for="sponsor in scoutpartner" :key="sponsor.id" :sponsor="sponsor">
                </app-sponsor>
            </div>
        </div>
