  ...
  <div class="container-fluid">
    ...
    <div class="container faq">
      <div class="offset-lg-1 col-lg-10">
        ...
        <h3>Moment… «MOSAIK»?</h3>
        <p>
          Jeder Teilnehmende bringt als Mosaikstein seine Ecken und Kanten ans PFF FFS 19 MOSAIK
          mit. Während dem ganzen Festival und den Konzerten bilden sich durch diese vielen
          verschiedenen anwesenden Mosaiksteinchen immer wieder neue Muster, Formen und Figuren. So
          erwarten wir im Sommer 2019 unzählig viele verschiedene Mosaikteilchen auf dem
          Festgelände, alle unterschiedlich und einzigartig. Sie vermischen sich, verändern sich
          gegenseitig und gehen mit neuen Erfahrungen und Eindrücken wieder auseinander. Ganz so,
          wie es in der Pfadi üblich ist.
        </p>

        <h3>Tickets</h3>
        <p>
          Der Ticketvorverkauf startet im Januar 2019. Erfahre als Erster vom Vorverkaufsstart und
        ...
        <h3>Sponsoren</h3>
        <p>
          Ein Grossanlass wie das PFF kommt trotz unzähligen Freiwilligenstunden nicht ohne
        ...
        <p>
          Das OK und 47´000 Pfadis aus der ganzen Schweiz danken Dir bereits jetzt für Deine
          Unterstützung!
        </p>

        <h3>Bands</h3>
        <p>
          Auch wenn bereits Gerüchte kursieren, ist das Line-Up noch nicht bekannt. Sobald wir
